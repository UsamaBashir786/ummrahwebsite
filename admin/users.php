...
// Average Age
$result = $conn->query("SELECT AVG(DATEDIFF(CURDATE(), dob)/365.25) as avg_age FROM users WHERE dob IS NOT NULL");
$stats['average_age'] = round($result->fetch_assoc()['avg_age'], 1);
