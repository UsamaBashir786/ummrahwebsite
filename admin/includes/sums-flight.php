...
<div class="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-6 mb-6">
    ...
    <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 border border-gray-200 shadow-sm">
        <div class="flex items-center">
            <div class="rounded-full bg-gray-500 p-3 mr-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div>
                <p class="text-sm text-gray-600 font-medium">Avg. Distance</p>
                <h3 class="text-2xl font-bold text-gray-800"><?php echo number_format($avgDistance); ?> km</h3>
            </div>
        </div>
    </div>
