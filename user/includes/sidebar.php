    ...
    <div class="space-y-8">
      ...
      <div>
        ...
        <ul class="mt-3 space-y-2">
          ...
          <li>
            <a href="settings.php" class="nav-link flex items-center px-3 py-2 text-sm font-semibold rounded-md <?= $currentPage == 'settings.php' ? 'text-white bg-cyan-600' : 'text-gray-800 hover:bg-cyan-100' ?>">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 <?= $currentPage == 'settings.php' ? 'text-white' : 'text-gray-600' ?>" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div>
        ...
        <ul class="mt-3 space-y-2">
          <li>
            <a href="help.php" class="nav-link flex items-center px-3 py-2 text-sm font-semibold rounded-md <?= $currentPage == 'help.php' ? 'text-white bg-cyan-600' : 'text-gray-800 hover:bg-cyan-100' ?>">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 <?= $currentPage == 'help.php' ? 'text-white' : 'text-gray-600' ?>" viewBox="0 0 20 20" fill="currentColor">
